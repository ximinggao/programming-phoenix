defmodule RumblWeb.VideoControllerTest do
  ...
  test "lists all user's videos on index", %{conn: conn, user: user} do
    category = insert_category("Test")
    user_video = insert_video(user, title: "funny cats", category: category)

    other_video =
      insert_video(insert_user(username: "other"), title: "other video", category: category)
  ...
  test "creates user video and redirects", %{conn: conn, user: user} do
    ...
    assert redirected_to(conn) == (video_path(conn, :show, video.id) <> "-vid")
  end
